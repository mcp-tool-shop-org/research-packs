# Gate Result: 08-acceptance-suite

**Verdict:** WARN
**Synthesis eligible:** yes
**Checked at:** 2026-05-08T04:44:18.628Z

> Verdict: warn. synthesis-eligible. no failures; 6 warning(s); no waivers.

## Counts

- Claims: 201 total, 201 candidate, 201 with evidence excerpt, 0 orphan
...
- Contradictions: 159 total (0 unresolved, 0 high/blocking)
- Scope integrity: 142 scoped, 59 universal/untagged, 0 with 'not' constraint, 0 overgeneralization risk(s) (0 blocking)
...
All 201 candidate claim(s) reference at least one source_id.
...
201/201 claim(s) source from a single publisher. Independent corroboration recommended before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_53ee6a9ec24b_ollama_intern_1`, `clm_53ee6a9ec24b_ollama_intern_2`, `clm_53ee6a9ec24b_ollama_intern_3`, `clm_53ee6a9ec24b_ollama_intern_4`, `clm_53ee6a9ec24b_ollama_intern_5`, `clm_53ee6a9ec24b_ollama_intern_6`, `clm_53ee6a9ec24b_ollama_intern_7`, `clm_53ee6a9ec24b_ollama_intern_8`, `clm_53ee6a9ec24b_ollama_intern_9`, `clm_53ee6a9ec24b_ollama_intern_10` (+191 more)

### [WARN] scope_integrity.no_untagged_universal_claims

59/201 candidate claim(s) have scope=null. These must not be treated as broad-applicability claims downstream — they are scope-undetermined, not scope-universal. Run a richer extractor or add scope manually before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_099defe2e6d6_ollama_intern_20`, `clm_099defe2e6d6_ollama_intern_21`, `clm_099defe2e6d6_ollama_intern_22`, `clm_099defe2e6d6_ollama_intern_23`, `clm_099defe2e6d6_ollama_intern_24`, `clm_642e49ac2548_ollama_intern_1`, `clm_642e49ac2548_ollama_intern_2`, `clm_642e49ac2548_ollama_intern_3`, `clm_642e49ac2548_ollama_intern_4`, `clm_642e49ac2548_ollama_intern_5` (+49 more)

### [WARN] scope_integrity.not_constraint_present

Only 0/201 candidate claim(s) carry a 'not' constraint. The 'not' field is the structural defense against overgeneralization; sparse coverage means downstream synthesis must be more cautious.
...
142 scoped, 59 universal/untagged, 0 with 'not' constraint.
...
All 159 contradiction(s) recorded are resolved.
...
Contradiction ledger has 159 entry(ies); policy satisfied.
...
15 accepted claims from 5 distinct sources (minimum: 3 from 2).
