# Gate Result: 04-gates-and-waivers

**Verdict:** WARN
**Synthesis eligible:** yes
**Checked at:** 2026-05-07T20:56:18.208Z

> Verdict: warn. synthesis-eligible. no failures; 7 warning(s); 1 waiver(s) applied.

## Counts

- Claims: 131 total, 131 candidate, 131 with evidence excerpt, 0 orphan
- Sources: 39 total (1 primary / 20 secondary / 1 docs / 0 forum / 0 benchmark / 17 unknown), 15 independent publishers, 42 failed fetches
- Contradictions: 0 total (0 unresolved, 0 high/blocking)
- Scope integrity: 125 scoped, 6 universal/untagged, 5 with 'not' constraint, 0 overgeneralization risk(s) (0 blocking)
...
15 independent publisher(s) >= minimum 4.
...
42 fetch attempt(s) recorded as non-ok in fetch-log.jsonl.

*Blocks synthesis:* false

### [PASS] claim_integrity.every_claim_needs_source

All 131 candidate claim(s) reference at least one source_id.
...
131/131 claim(s) source from a single publisher. Independent corroboration recommended before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_09a48e752e9b_ollama_intern_1`, `clm_09a48e752e9b_ollama_intern_2`, `clm_09a48e752e9b_ollama_intern_3`, `clm_fb48d4730a5c_ollama_intern_1`, `clm_fb48d4730a5c_ollama_intern_2`, `clm_fb48d4730a5c_ollama_intern_3`, `clm_fb48d4730a5c_ollama_intern_4`, `clm_fb48d4730a5c_ollama_intern_5`, `clm_fb48d4730a5c_ollama_intern_6`, `clm_fb48d4730a5c_ollama_intern_7` (+121 more)

### [WARN] scope_integrity.no_untagged_universal_claims

6/131 candidate claim(s) have scope=null. These must not be treated as broad-applicability claims downstream — they are scope-undetermined, not scope-universal. Run a richer extractor or add scope manually before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_09a48e752e9b_ollama_intern_3`, `clm_09a48e752e9b_ollama_intern_4`, `clm_09a48e752e9b_ollama_intern_5`, `clm_09a48e752e9b_ollama_intern_6`, `clm_55f4bfa87f54_ollama_intern_13`, `clm_bbd08b91cbb6_ollama_intern_3`

### [WARN] scope_integrity.not_constraint_present

Only 5/131 candidate claim(s) carry a 'not' constraint. The 'not' field is the structural defense against overgeneralization; sparse coverage means downstream synthesis must be more cautious.

*Blocks synthesis:* false

*Evidence:* `clm_09a48e752e9b_ollama_intern_1`, `clm_09a48e752e9b_ollama_intern_2`, `clm_09a48e752e9b_ollama_intern_3`, `clm_fb48d4730a5c_ollama_intern_1`, `clm_fb48d4730a5c_ollama_intern_2`, `clm_fb48d4730a5c_ollama_intern_3`, `clm_fb48d4730a5c_ollama_intern_4`, `clm_fb48d4730a5c_ollama_intern_5`, `clm_fb48d4730a5c_ollama_intern_6`, `clm_fb48d4730a5c_ollama_intern_7` (+116 more)
...
125 scoped, 6 universal/untagged, 5 with 'not' constraint.
...
*Evidence:* `src_05cae033cedc`, `src_099defe2e6d6`, `src_09a48e752e9b`, `src_0b75376a48e4`, `src_155c4be7850d`, `src_27eaf34f91a3`, `src_2fff6e91c56c`, `src_458d9788c68d`, `src_53ee6a9ec24b`, `src_55f4bfa87f54` (+28 more)
...
30 accepted claims from 5 distinct sources (minimum: 3 from 2).
