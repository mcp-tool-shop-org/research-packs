...
**Checked at:** 2026-05-08T05:55:26.507Z

> Verdict: warn. synthesis-eligible. no failures; 7 warning(s); no waivers.

## Counts

- Claims: 715 total, 715 candidate, 715 with evidence excerpt, 0 orphan
...
- Scope integrity: 338 scoped, 377 universal/untagged, 111 with 'not' constraint, 0 overgeneralization risk(s) (0 blocking)
...
All 715 candidate claim(s) reference at least one source_id.
...
715/715 claim(s) source from a single publisher. Independent corroboration recommended before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_676ddfa834cc_ollama_intern_1`, `clm_676ddfa834cc_ollama_intern_2`, `clm_676ddfa834cc_ollama_intern_3`, `clm_d39cd3ba0ef2_ollama_intern_1`, `clm_d39cd3ba0ef2_ollama_intern_2`, `clm_d39cd3ba0ef2_ollama_intern_3`, `clm_d39cd3ba0ef2_ollama_intern_4`, `clm_d39cd3ba0ef2_ollama_intern_5`, `clm_d39cd3ba0ef2_ollama_intern_6`, `clm_d39cd3ba0ef2_ollama_intern_7` (+705 more)

### [WARN] scope_integrity.no_untagged_universal_claims

377/715 candidate claim(s) have scope=null. These must not be treated as broad-applicability claims downstream — they are scope-undetermined, not scope-universal. Run a richer extractor or add scope manually before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_d81a8a3d6bba_ollama_intern_6`, `clm_d81a8a3d6bba_ollama_intern_7`, `clm_d81a8a3d6bba_ollama_intern_8`, `clm_d81a8a3d6bba_ollama_intern_9`, `clm_d81a8a3d6bba_ollama_intern_10`, `clm_d81a8a3d6bba_ollama_intern_11`, `clm_d81a8a3d6bba_ollama_intern_12`, `clm_d81a8a3d6bba_ollama_intern_13`, `clm_d81a8a3d6bba_ollama_intern_14`, `clm_d81a8a3d6bba_ollama_intern_15` (+367 more)

### [WARN] scope_integrity.not_constraint_present

Only 111/715 candidate claim(s) carry a 'not' constraint. The 'not' field is the structural defense against overgeneralization; sparse coverage means downstream synthesis must be more cautious.
...
338 scoped, 377 universal/untagged, 111 with 'not' constraint.
...
42 accepted claims from 7 distinct sources (minimum: 3 from 2).
