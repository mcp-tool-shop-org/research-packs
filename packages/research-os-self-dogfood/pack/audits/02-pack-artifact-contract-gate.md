# Gate Result: 02-pack-artifact-contract

**Verdict:** WARN
**Synthesis eligible:** yes
**Checked at:** 2026-05-08T04:50:51.105Z

> Verdict: warn. synthesis-eligible. no failures; 7 warning(s); no waivers.

## Counts

- Claims: 471 total, 471 candidate, 471 with evidence excerpt, 0 orphan
...
- Scope integrity: 406 scoped, 65 universal/untagged, 10 with 'not' constraint, 0 overgeneralization risk(s) (0 blocking)
...
All 471 candidate claim(s) reference at least one source_id.
...
471/471 claim(s) source from a single publisher. Independent corroboration recommended before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_cf2238f43a01_ollama_intern_1`, `clm_cf2238f43a01_ollama_intern_2`, `clm_cf2238f43a01_ollama_intern_3`, `clm_cf2238f43a01_ollama_intern_4`, `clm_cf2238f43a01_ollama_intern_5`, `clm_cf2238f43a01_ollama_intern_6`, `clm_cf2238f43a01_ollama_intern_7`, `clm_cf2238f43a01_ollama_intern_8`, `clm_cf2238f43a01_ollama_intern_9`, `clm_cf2238f43a01_ollama_intern_10` (+461 more)

### [WARN] scope_integrity.no_untagged_universal_claims

65/471 candidate claim(s) have scope=null. These must not be treated as broad-applicability claims downstream — they are scope-undetermined, not scope-universal. Run a richer extractor or add scope manually before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_bf5d0eef78f0_ollama_intern_1`, `clm_bf5d0eef78f0_ollama_intern_2`, `clm_bf5d0eef78f0_ollama_intern_3`, `clm_bf5d0eef78f0_ollama_intern_4`, `clm_bf5d0eef78f0_ollama_intern_5`, `clm_bf5d0eef78f0_ollama_intern_6`, `clm_bf5d0eef78f0_ollama_intern_7`, `clm_62d58636ae35_ollama_intern_1`, `clm_62d58636ae35_ollama_intern_2`, `clm_62d58636ae35_ollama_intern_3` (+55 more)

### [WARN] scope_integrity.not_constraint_present

Only 10/471 candidate claim(s) carry a 'not' constraint. The 'not' field is the structural defense against overgeneralization; sparse coverage means downstream synthesis must be more cautious.

*Blocks synthesis:* false

*Evidence:* `clm_cf2238f43a01_ollama_intern_1`, `clm_cf2238f43a01_ollama_intern_2`, `clm_cf2238f43a01_ollama_intern_3`, `clm_cf2238f43a01_ollama_intern_4`, `clm_cf2238f43a01_ollama_intern_5`, `clm_cf2238f43a01_ollama_intern_6`, `clm_cf2238f43a01_ollama_intern_7`, `clm_cf2238f43a01_ollama_intern_8`, `clm_cf2238f43a01_ollama_intern_9`, `clm_cf2238f43a01_ollama_intern_10` (+451 more)
...
406 scoped, 65 universal/untagged, 10 with 'not' constraint.
...
50 accepted claims from 7 distinct sources (minimum: 3 from 2).
