# Gate Result: 07-metadata-and-off-chain-durability

**Verdict:** WARN
**Synthesis eligible:** yes
**Checked at:** 2026-05-09T22:42:21.946Z

> Verdict: warn. synthesis-eligible. no failures; 7 warning(s); no waivers.

## Counts

- Claims: 300 total, 300 candidate, 300 with evidence excerpt, 0 orphan
...
- Scope integrity: 207 scoped, 93 universal/untagged, 47 with 'not' constraint, 0 overgeneralization risk(s) (0 blocking)
...
All 300 candidate claim(s) reference at least one source_id.
...
300/300 claim(s) source from a single publisher. Independent corroboration recommended before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_3cc91a11ac53_ollama_intern_1`, `clm_3cc91a11ac53_ollama_intern_2`, `clm_3cc91a11ac53_ollama_intern_3`, `clm_3cc91a11ac53_ollama_intern_4`, `clm_3cc91a11ac53_ollama_intern_5`, `clm_3cc91a11ac53_ollama_intern_6`, `clm_517d67dc1224_ollama_intern_1`, `clm_517d67dc1224_ollama_intern_2`, `clm_517d67dc1224_ollama_intern_3`, `clm_517d67dc1224_ollama_intern_4` (+290 more)

### [WARN] scope_integrity.no_untagged_universal_claims

93/300 candidate claim(s) have scope=null. These must not be treated as broad-applicability claims downstream — they are scope-undetermined, not scope-universal. Run a richer extractor or add scope manually before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_3cc91a11ac53_ollama_intern_1`, `clm_517d67dc1224_ollama_intern_3`, `clm_517d67dc1224_ollama_intern_4`, `clm_517d67dc1224_ollama_intern_5`, `clm_517d67dc1224_ollama_intern_6`, `clm_ff9fbb4f8527_ollama_intern_1`, `clm_ff9fbb4f8527_ollama_intern_2`, `clm_ff9fbb4f8527_ollama_intern_3`, `clm_ff9fbb4f8527_ollama_intern_4`, `clm_ff9fbb4f8527_ollama_intern_5` (+83 more)

### [WARN] scope_integrity.not_constraint_present

Only 47/300 candidate claim(s) carry a 'not' constraint. The 'not' field is the structural defense against overgeneralization; sparse coverage means downstream synthesis must be more cautious.
...
207 scoped, 93 universal/untagged, 47 with 'not' constraint.
...
19 accepted claims from 5 distinct sources (minimum: 3 from 2).
