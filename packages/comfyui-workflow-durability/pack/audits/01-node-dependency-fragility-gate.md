# Gate Result: 01-node-dependency-fragility

**Verdict:** WARN
**Synthesis eligible:** yes
**Checked at:** 2026-05-09T03:53:25.708Z

> Verdict: warn. synthesis-eligible. no failures; 7 warning(s); 1 waiver(s) applied.

## Counts

- Claims: 169 total, 169 candidate, 169 with evidence excerpt, 0 orphan
- Sources: 36 total (0 primary / 15 secondary / 16 docs / 0 forum / 0 benchmark / 5 unknown), 2 independent publishers, 5 failed fetches
- Contradictions: 0 total (0 unresolved, 0 high/blocking)
- Scope integrity: 159 scoped, 10 universal/untagged, 0 with 'not' constraint, 0 overgeneralization risk(s) (0 blocking)
...
All 169 candidate claim(s) reference at least one source_id.
...
169/169 claim(s) source from a single publisher. Independent corroboration recommended before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_aede2f10d470_ollama_intern_1`, `clm_aede2f10d470_ollama_intern_2`, `clm_aede2f10d470_ollama_intern_3`, `clm_aede2f10d470_ollama_intern_4`, `clm_aede2f10d470_ollama_intern_5`, `clm_aede2f10d470_ollama_intern_6`, `clm_aede2f10d470_ollama_intern_7`, `clm_aede2f10d470_ollama_intern_8`, `clm_aede2f10d470_ollama_intern_9`, `clm_aede2f10d470_ollama_intern_10` (+159 more)

### [WARN] scope_integrity.no_untagged_universal_claims

10/169 candidate claim(s) have scope=null. These must not be treated as broad-applicability claims downstream — they are scope-undetermined, not scope-universal. Run a richer extractor or add scope manually before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_2c5240f22e27_ollama_intern_1`, `clm_2c5240f22e27_ollama_intern_2`, `clm_2c5240f22e27_ollama_intern_3`, `clm_2c5240f22e27_ollama_intern_4`, `clm_2c5240f22e27_ollama_intern_5`, `clm_2c5240f22e27_ollama_intern_6`, `clm_ed31f644833c_ollama_intern_4`, `clm_ed31f644833c_ollama_intern_6`, `clm_ed31f644833c_ollama_intern_19`, `clm_ed31f644833c_ollama_intern_20`

### [WARN] scope_integrity.not_constraint_present

Only 0/169 candidate claim(s) carry a 'not' constraint. The 'not' field is the structural defense against overgeneralization; sparse coverage means downstream synthesis must be more cautious.
...
159 scoped, 10 universal/untagged, 0 with 'not' constraint.
...
*Evidence:* `src_07437ed8d167`, `src_0a0723012f3c`, `src_118111ce7028`, `src_155d801f1917`, `src_19e3c332733b`, `src_19f4e9c54b47`, `src_1e2124f6f8d4`, `src_2ae04b870db8`, `src_2c5240f22e27`, `src_417fb676dd7b` (+25 more)
...
40 accepted claims from 8 distinct sources (minimum: 3 from 2).
