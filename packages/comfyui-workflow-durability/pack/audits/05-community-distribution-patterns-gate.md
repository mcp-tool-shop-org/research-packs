# Gate Result: 05-community-distribution-patterns

**Verdict:** WARN
**Synthesis eligible:** yes
**Checked at:** 2026-05-09T07:08:52.906Z

> Verdict: warn. synthesis-eligible. no failures; 6 warning(s); no waivers.

## Counts

- Claims: 108 total, 108 candidate, 108 with evidence excerpt, 0 orphan
- Sources: 59 total (2 primary / 20 secondary / 28 docs / 3 forum / 0 benchmark / 6 unknown), 3 independent publishers, 6 failed fetches
- Contradictions: 0 total (0 unresolved, 0 high/blocking)
- Scope integrity: 108 scoped, 0 universal/untagged, 0 with 'not' constraint, 0 overgeneralization risk(s) (0 blocking)
- Freshness: policy required, 0 stale, 58 unknown date

## Gate results

### [PASS] source_floor.min_sources

59 source card(s) >= minimum 8.

*Blocks synthesis:* false

### [PASS] source_floor.min_independent_publishers

3 independent publisher(s) >= minimum 0.
...
All 108 candidate claim(s) reference at least one source_id.
...
108/108 claim(s) source from a single publisher. Independent corroboration recommended before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_e7045b6bccdb_ollama_intern_1`, `clm_e7045b6bccdb_ollama_intern_2`, `clm_e7045b6bccdb_ollama_intern_3`, `clm_e7045b6bccdb_ollama_intern_4`, `clm_e7045b6bccdb_ollama_intern_5`, `clm_fcdd7f1c90e9_ollama_intern_1`, `clm_fcdd7f1c90e9_ollama_intern_2`, `clm_fcdd7f1c90e9_ollama_intern_3`, `clm_fcdd7f1c90e9_ollama_intern_4`, `clm_fcdd7f1c90e9_ollama_intern_5` (+98 more)
...
Only 0/108 candidate claim(s) carry a 'not' constraint. The 'not' field is the structural defense against overgeneralization; sparse coverage means downstream synthesis must be more cautious.
...
108 scoped, 0 universal/untagged, 0 with 'not' constraint.
...
58 source(s) have no parseable published_at. Recency cannot be evaluated for these.

*Blocks synthesis:* false

*Evidence:* `src_049006574d3f`, `src_07126047391f`, `src_07437ed8d167`, `src_0a0723012f3c`, `src_0a3149c031c5`, `src_118111ce7028`, `src_155d801f1917`, `src_19e3c332733b`, `src_19f4e9c54b47`, `src_1e2124f6f8d4` (+48 more)
...
15 accepted claims from 4 distinct sources (minimum: 3 from 2).
