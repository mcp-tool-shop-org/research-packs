# Gate Result: 04-environment-reproducibility

**Verdict:** WARN
**Synthesis eligible:** yes
**Checked at:** 2026-05-09T06:12:08.014Z

> Verdict: warn. synthesis-eligible. no failures; 7 warning(s); 1 waiver(s) applied.

## Counts

- Claims: 284 total, 284 candidate, 284 with evidence excerpt, 0 orphan
- Sources: 56 total (1 primary / 20 secondary / 28 docs / 1 forum / 0 benchmark / 6 unknown), 2 independent publishers, 6 failed fetches
- Contradictions: 0 total (0 unresolved, 0 high/blocking)
- Scope integrity: 214 scoped, 70 universal/untagged, 12 with 'not' constraint, 0 overgeneralization risk(s) (0 blocking)
- Freshness: policy required, 0 stale, 55 unknown date
...
All 284 candidate claim(s) reference at least one source_id.
...
284/284 claim(s) source from a single publisher. Independent corroboration recommended before synthesis.

*Blocks synthesis:* false

*Evidence:* `clm_a8c5d541c698_heuristic_1`, `clm_a8c5d541c698_heuristic_2`, `clm_664a4a54b4c3_heuristic_1`, `clm_664a4a54b4c3_heuristic_2`, `clm_b81c03003037_heuristic_1`, `clm_b81c03003037_heuristic_2`, `clm_b81c03003037_heuristic_3`, `clm_2a30a3ff7502_heuristic_1`, `clm_2a30a3ff7502_heuristic_2`, `clm_f9b159fab5ef_heuristic_1` (+274 more)

### [WARN] scope_integrity.no_untagged_universal_claims

70/284 candidate claim(s) have scope=null. These must not be treated as broad-applicability claims downstream — they are scope-undetermined, not scope-universal. Run a richer extractor or add scope manually before synthesis.
...
Only 12/284 candidate claim(s) carry a 'not' constraint. The 'not' field is the structural defense against overgeneralization; sparse coverage means downstream synthesis must be more cautious.
...
214 scoped, 70 universal/untagged, 12 with 'not' constraint.
...
55 source(s) have no parseable published_at. Recency cannot be evaluated for these.

*Blocks synthesis:* false

*Evidence:* `src_049006574d3f`, `src_07126047391f`, `src_07437ed8d167`, `src_0a0723012f3c`, `src_0a3149c031c5`, `src_118111ce7028`, `src_155d801f1917`, `src_19e3c332733b`, `src_19f4e9c54b47`, `src_1e2124f6f8d4` (+45 more)
...
74 accepted claims from 11 distinct sources (minimum: 3 from 2).
